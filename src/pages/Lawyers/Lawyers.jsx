...
const Lawyers = () => {
    ...
    return (
        <div className='text-black mt-18 md:my-24'>
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-11 mt-6 md:mt-10">
                {
                    showLawyers.map(lawyer => <Lawyer key={lawyer.id} lawyer={lawyer}></Lawyer>)
                }
            </div>
            {
                !showAll && <button onClick={() => setShowAll(true)}
                className="btn flex justify-self-center md:mt-10 mt-5 px-12">Show All</button>
            }
        </div>
    );
};
